...
describe('ClassifiedErrorCallout', () => {
  it('renders title, message, remediation and correlation id', () => {
    render(<ClassifiedErrorCallout error={classified()} />);
  ...
  it('shows a safe-details accordion and omits raw details when none are exposed', () => {
    render(
      <ClassifiedErrorCallout
        error={classified({
          details: [
            { key: 'redactedDetail', label: 'Details', value: 'invalid PromQL: parse error', sensitivity: 'safe' },
          ],
        })}
      />
    );
  ...
  it('shows a raw-details accordion when sensitive details are exposed', () => {
    render(
      <ClassifiedErrorCallout
        error={classified({
          details: [
            { key: 'rawDetail', label: 'Raw error details', value: 'verbatim upstream body', sensitivity: 'sensitive' },
          ],
        })}
      />
    );
