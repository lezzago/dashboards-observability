 ...
 *   - 10 read routes + 1 Alertmanager admin route registered inline (11 GETs;
 *     Phase 2 added `/api/alerting/unified/alerts/timeline`)
...
describe('registerAlertingRoutes', () => {
  ...
  it('registers all runtime routes when metadata routes are enabled (15 GET + 4 mutations = 19)', () => {
    ...
    // 11 inline GETs + 4 conditional metadata GETs = 15 GETs total
